...
ROADMAP §B19.2. The file next door is the source of truth for what a published
number counts; this is the twenty lines that apply it. Kept apart so the rules
can be read, diffed and argued with by somebody who does not read Python.
"""
