...
- **New in v0.1.8: Auditable Sandbox.** Run risky AI-generated code inside a confined Git worktree, capture every command, blocked access, policy, output, and diff, then apply the change only after review. [Jump to Agent Sandbox ↓](#32-agent-sandbox--a-confined-fully-auditable-environment)
