...
//!
//! `h5i browser transcript` reads the captions a page declares. YouTube keeps
...
//! is refused rather than served from the host, which would move the network to
//! a boundary the caller did not choose.
//!
